...
$faxc_class = ($params->get('jquery-local',0))? 'fancyboxLoc' : 'fancybox' ;
?>
              ...
              endforeach;
		         ...
		         foreach ($images as $i=>$image):
                  ...
                  $alt = ($image->alt) ? " alt='".$image->alt."' title='".$image->alt."' " :"";
                    ...
                    ?>
                      <a href="<?php echo  JURI::root() . $dir.'/original/'.$image->file; ?>" rel="group" class="<?php echo $faxc_class;?>"><!-- original img -->
...
<script type="text/javascript">
  <?php if($params->get('jquery-local',0)){ ?>
    jQuerLoc(document).ready(function(){
      var widwind = jQuerLoc(window).width();
      var img = jQuerLoc("#osgallery<?php echo $module->id;?> .<?php echo $faxc_class;?>");
    ...
    jQuery(document).ready(function(){
      ...
      var img = jQuery("#osgallery<?php echo $module->id;?> .<?php echo $faxc_class;?>");
      var iminrow = <?php echo $img_in_row;?>;
      var ele = Math.round((100/iminrow)-3.5);
          img.css({width: ele+'%'});
